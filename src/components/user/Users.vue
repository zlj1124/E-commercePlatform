      ...
      <el-table :data="userlist" border stripe>
        ...
        <el-table-column label="操作" width="180px">
          <template slot-scope="scope">
            ...
            <!-- 删除按钮 -->
            <el-tooltip effect="dark" content="删除删除" placement="top" :enterable="false">
              <el-button
                type="danger"
                icon="el-icon-delete"
                size="mini"
  ...
  methods: {
    ...
    async setRoleInfo() {
      if (!this.selectedRoleId) {
        return this.$message.error('情选择要分配的角色！')
      }
      const { data: res } = await this.$http.put(
